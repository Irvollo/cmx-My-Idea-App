...
export default class EditableIdea extends Component {
    ...
    constructor () {
        ...
        this.removeEditHandler = this.removeEditHandler.bind(this)
    }
    ...
    handleSubmit(event) {
        ...
        console.log(ideaBody, ideaHeaders)
        ...
        .then(newIdea => {
            console.log(newIdea)
            this.props.onNewIdea(newIdea)
        })
    }

    removeEditHandler(e) {
        this.props.onRemoveEdit(this.props.id);
    }
      ...
      <li>
          ...
          <Grid container spacing={8} >
            ...
            <Grid item xs={4} sm={1}>
                <br/>
                <Button >
                     <Clear onClick={this.removeEditHandler}/>
                </Button>   
            </Grid>
        </ Grid>
        </form>
